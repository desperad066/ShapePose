...
def train():
    ...
    for i in range(start_iter, args.num_iterations + 1):
        ...
        # after chunk, the render_image is a tuple, so the multiview_iou_loss will [0] balabala
        print('render',render_images[0].size())
        print('image',images_a.size())
        print('view', viewpoints_a.size())
        exit()
